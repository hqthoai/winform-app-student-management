...
namespace StudentManagement.Dataset {
    ...
    public partial class QLSVDataSet1 : global::System.Data.DataSet {
        ...
        public partial class AccountDataTable : global::System.Data.TypedTableBase<AccountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AccountRow AddAccountRow(string username, string password, string firstname, string lastname, string gender, string phone, string email, string roles) {
...
namespace StudentManagement.Dataset.QLSVDataSet1TableAdapters {
    ...
    public partial class AccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Account] ([username], [password], [firstname], [lastname], [gender], [phone], [email], [roles]) VALUES (@username, @password, @firstname, @lastname, @gender, @phone, @email, @roles);
SELECT username, password, firstname, lastname, gender, phone, email, roles FROM Account WHERE (username = @username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Account] SET [username] = @username, [password] = @password, [firstname] = @firstname, [lastname] = @lastname, [gender] = @gender, [phone] = @phone, [email] = @email, [roles] = @roles WHERE (([username] = @Original_username) AND ([password] = @Original_password) AND ([firstname] = @Original_firstname) AND ([lastname] = @Original_lastname) AND ([gender] = @Original_gender) AND ([phone] = @Original_phone) AND ([email] = @Original_email) AND ((@IsNull_roles = 1 AND [roles] IS NULL) OR ([roles] = @Original_roles)));
SELECT username, password, firstname, lastname, gender, phone, email, roles FROM Account WHERE (username = @username)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, password, firstname, lastname, gender, phone, email, roles FROM " +
                "dbo.Account";
        ...
        public virtual int Fill(QLSVDataSet1.AccountDataTable dataTable) {
        ...
        public virtual QLSVDataSet1.AccountDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLSVDataSet1.AccountDataTable dataTable = new QLSVDataSet1.AccountDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLSVDataSet1.AccountDataTable dataTable) {
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_firstname, string Original_lastname, string Original_gender, string Original_phone, string Original_email, string Original_roles) {
        ...
        public virtual int Insert(string username, string password, string firstname, string lastname, string gender, string phone, string email, string roles) {
            if ((username == null)) {
        ...
        public virtual int Update(
            ...
            if ((roles == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(roles));
            }
            if ((Original_username == null)) {
                throw new global::System.ArgumentNullException("Original_username");
            }
            ...
            if ((Original_roles == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_roles));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string firstname, string lastname, string gender, string phone, string email, string roles, string Original_username, string Original_password, string Original_firstname, string Original_lastname, string Original_gender, string Original_phone, string Original_email, string Original_roles) {
            return this.Update(Original_username, password, firstname, lastname, gender, phone, email, roles, Original_username, Original_password, Original_firstname, Original_lastname, Original_gender, Original_phone, Original_email, Original_roles);
        }
    }
