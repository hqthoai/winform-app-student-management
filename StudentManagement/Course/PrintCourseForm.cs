...
namespace StudentManagement.Course
{
    public partial class PrintCourseForm : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qLSVCourse.Course' table. You can move, or remove it, as needed.
            this.courseTableAdapter.Fill(this.qLSVCourse.Course);
        ...
        public void ExportToWord(DataGridView DGV)
        {
            ...
            object fileName = @"C:\Users\HP\Desktop\HK2_Nam_3\Window_Programming\export\CourseExport.docx";
        ...
        private void buttonPrint_Click(object sender, EventArgs e)
        {
            ...
            printDoc.DocumentName = "Print Course Document";
