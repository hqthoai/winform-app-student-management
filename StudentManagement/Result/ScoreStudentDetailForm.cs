...
{
    public partial class ScoreStudentDetailForm : Form
    {
        public ScoreStudentDetailForm()
        {
            InitializeComponent();
        }
        ...
        private void ScoreStudentDetailForm_Load(object sender, EventArgs e)
        {
            labelID.Text = sid;
            ...
            sqlCommand.Parameters.AddWithValue("@id", SqlDbType.NVarChar).Value = sid;
